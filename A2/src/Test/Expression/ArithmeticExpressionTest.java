...
class ArithmeticExpressionTest {
    ...
    @Test
    void eval() {
        IntValue expr = (IntValue)this.arithmetic_expr.eval(sym_table);
        ...
        assertThrows(myException.class,() -> {
            ...
            ImyDictionary<String,Value> sym_table = new myDictionary<String, Value>();
            wrong_operation.eval(sym_table);
        });
        assertThrows(myException.class,() -> {
            ...
            ImyDictionary<String,Value> sym_table = new myDictionary<String, Value>();
            division_by_zero.eval(sym_table);
        });
    }

    @Test
    void getType() {
        assertEquals(new IntType(), this.arithmetic_expr.eval(this.sym_table).getType());
    }
}