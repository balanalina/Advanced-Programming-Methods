...
public class ProgramState {
    ...
    public ProgramState(ImyStack<IStatement> stack, ImyDictionary<String, Value> sym, ImyList<Value> out, IStatement prg){
        this.execution_stack = stack;
        this.symbol_table = sym;
        this.out_table = out;
        this.file_table = new myDictionary<>();
        this.heap_table = new myHeap<>();
